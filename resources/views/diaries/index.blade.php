        ...
        @forelse($diaries as $diary)
            <li class="diary_box">
                ...
                <div class="stream_start">
                    ...
                    <p class="before_body">{!! nl2br(htmlspecialchars($diary->before_body)) !!}</p>
                </div>

                <div>
                    <p class="diary_tag">ふりかえり</p>
                    <p class="after_body">{!! nl2br(htmlspecialchars($diary->after_body)) !!}</p>
                <div>

                <div>
                    <p class="created_at">（{{ $diary->created_at }}）</p>
                <div>
            </li>
        @empty
            <li>投稿はありません。</li>
